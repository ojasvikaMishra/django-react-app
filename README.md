...
This is a simple Todo (CURD) application built off Django (including the Django REST Framework for API CRUD operations) and React. For a complete walkthrough, see this which is  Using Django  and React.
